		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="horticultural waste" style="color: black;">Horticultural Waste</option>
										<option value="crop residues" style="color: black;">Crop Residues</option>
										<option value="tree waste" style="color: black;">Tree Waste</option>
										<option value="animal waste" style="color: black;">Animal Waste</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
				...
				<?php
					...
					switch ($type) {
						case "horticultural waste":
							$sql = "SELECT * FROM fproduct WHERE pcat = 'Horticultural Waste'";
							break;
						case "crop residues":
							$sql = "SELECT * FROM fproduct WHERE pcat = 'Crop Residues'";
							break;
						case "tree waste":
							$sql = "SELECT * FROM fproduct WHERE pcat = 'Tree Waste'";
							break;
							case "animal waste":
								$sql = "SELECT * FROM fproduct WHERE pcat = 'Animal Waste'";
								break;
						case "all":
						default:
